...
class Slider:
    ...
    def __init__(self, surface, coords, length, initValue=50, lineColor=(220, 220, 230), sliderColor=(46, 119, 230), sliderDraggedColor=(58, 158, 240)):
        self.coords = coords
        ...
        self.surface = pygame.Surface([self.length + (self.sliderRadius * 2), self.surfHeight], pygame.SRCALPHA) # Draws surface
    ...
    def redrawSurface(self):
        ...
        pygame.draw.circle(self.surface, self.sliderColor, (round(self.sliderPos), self.surfHeight//2), self.sliderRadius) # Draws circle
